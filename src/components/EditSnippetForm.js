...
const EditSnippetForm = ({snippetData,closeEditMode}) => {
    ...
    const onSubmit = (data) =>{  //data : name,language,description,code
        ...
        dispatch(updateSnippet(snippetData._id,updatedSnippet))
        reset()
        closeEditMode();
    }
                ...
                <div style={{padding:"20px"}}>
                    <form noValidate="off" autoComplete="off" onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <Controller
                            ...
                            defaultValue={snippetData?.language}
                        />
                        <TextField
                            id="description"
                            label="Description"
                        ...
                        <Button className={classes.button} style={{color: "#ffffff", width: "108px"}} onClick={closeEditMode}
                        ...
                        <Button className={classes.button} style={{color: "#ffffff", width: "108px"}} type="submit"
                                startIcon={<DoneIcon style={{color: "white"}}/>}
                        >
